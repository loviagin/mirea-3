...
<div class="container pb-5 fade-in">
  ...
  <div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
      <div class="border rounded p-3 text-center metric-card shadow-sm">
        <div class="small text-muted mb-1">Скорость МКС</div>
        <div class="fs-4 fw-bold">{{ isset(($iss['payload'] ?? [])['velocity']) ? number_format($iss['payload']['velocity'],0,'',' ') : '—' }}</div>
    ...
    <div class="col-6 col-md-3">
      <div class="border rounded p-3 text-center metric-card shadow-sm">
        ...
        <div class="fs-4 fw-bold">{{ isset(($iss['payload'] ?? [])['altitude']) ? number_format($iss['payload']['altitude'],0,'',' ') : '—' }}</div>
